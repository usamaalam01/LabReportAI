      ...
      <div className="flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4 sm:justify-center">
        ...
        {data.status === "completed" && (
          <button
            ...
            aria-label="Open chat to discuss your report"
            className="inline-flex items-center justify-center rounded-md bg-purple-600 px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 animate-attention-pulse"
          >
            <svg
              className="mr-2 h-5 w-5"
              fill="none"
